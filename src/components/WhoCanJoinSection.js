    ...
    <div className="bg-[#f7f7f7] md:px-24">
      <section className="text-center p-6">
        ...
        <p className="my-6 text-gray-600 text-justify md:mx-14">
          ...
          Our target candidates include serving NYSC members,
          recent graduates, as well as third and final year students
          of Nigeria Universities and Polytechnics; unemployed graduates;
          working professionals in any field though preference will be given to
          Computer / Physical Science and Engineering fields.
        ...
        <p className="my-6 text-gray-600 text-justify md:mx-14">
          Oriental CyberSecurity Training and Mentorship Programme is a programme established and organized by a team of Nigerian Cyber Security experts based in Nigeria, Canada and Europe to deliver a first-hand training and mentorship programme on Information/Cyber security to  interested Nigerians who are ready to acquire basic skills on info/Cybersecurity to enable them protect and defend themselves and organizations against cyber attacks and possibly begin the journey of making a career in the interesting and highly rewarding field  of Info/Cyber Security.
